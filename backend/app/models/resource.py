...
class InboxItem(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """收集箱条目"""
...
class Template(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """模板库"""
...
class Domain(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """领域库"""
