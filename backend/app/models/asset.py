...
class SOP(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """SOP流程"""
    __tablename__ = "sops"
    __table_args__ = (
...
class SOPVersion(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """SOP版本历史"""
...
class PromptTemplate(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """Prompt模板"""
...
class Skill(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """Skill技能"""
...
class ProjectMemory(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """项目记忆"""
