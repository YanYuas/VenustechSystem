...
class StudyPlan(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """学习计划"""
...
class Flashcard(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """知识卡片（SM-2间隔重复）"""
...
class StudyTimeLog(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """学习时长记录"""
