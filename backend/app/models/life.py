...
class HabitCheckin(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """习惯打卡记录"""
...
class MoodLog(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """心情记录"""
...
class Diary(UUIDMixin, TimestampMixin, SoftDeleteMixin, Base):
    """四维日记"""
