...
from app.models.learning import StudyPlan
...
class StudyPlanRepository(BaseRepository[StudyPlan]):
    ...
    def list_by_user(self, user_id: str, skip: int = 0, limit: int = 100) -> list[StudyPlan]:
        return self.list(skip=skip, limit=limit, user_id=user_id)

    def count_by_user(self, user_id: str) -> int:
        return self.count(user_id=user_id)

    def list_active(self, user_id: str) -> list[StudyPlan]:
