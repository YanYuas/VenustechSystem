...
declare module 'vue' {
  export interface GlobalComponents {
    ActionSheet: typeof import('./components/common/ActionSheet.vue')['default']
    ...
    DimensionTabs: typeof import('./components/layout/DimensionTabs.vue')['default']
    DocumentGraph: typeof import('./components/document/DocumentGraph.vue')['default']
