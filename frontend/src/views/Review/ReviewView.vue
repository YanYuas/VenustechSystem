...
const { identityOptions, loadIdentities } = useIdentity()
...
function selectTemplate(t: ReviewTemplate) {
  ...
  form.value = { completed_tasks: '', gains: '', tomorrow_plan: '', mood: '4', energy: '3', identity_id: '' }
  reflections.value = []
...
const form = ref({ completed_tasks: '', gains: '', tomorrow_plan: '', mood: '4', energy: '3', identity_id: '' })
  ...
  <div class="review">
    ...
    <BaseModal v-model="writeOpen" title="今日复盘" @confirm="onSave">
      <div class="review__form">
        ...
        <label class="review__field">
          <span class="review__label">所属身份（可选，挂进经历时间线）</span>
          <BaseSelect v-model="form.identity_id" :options="identityOptions(true)" />
        </label>
