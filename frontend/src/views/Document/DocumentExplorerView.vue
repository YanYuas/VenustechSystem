...
// 首页快速入口「新建笔记」带 ?action=new 直达新建弹窗（R-02）
...
async function onCreate() {
  ...
  const doc = await createDocument({ title, folder_id: newFolderId.value || undefined, identity_id: newIdentityId.value || undefined, content })
  toast.success('文档已创建')
